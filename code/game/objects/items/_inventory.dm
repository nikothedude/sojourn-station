...
/obj/item/proc/equipped(var/mob/user, var/slot)
	...
	SEND_SIGNAL_LEGACY(user, COMSIG_CLOTH_EQUIPPED, src) // Theres instances in which its usefull to keep track of it both on the user and individually
	SEND_SIGNAL_LEGACY(src, COMSIG_CLOTH_EQUIPPED)
	*/
