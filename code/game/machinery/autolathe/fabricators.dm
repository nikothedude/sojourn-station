...
/obj/machinery/bulletfabricator
	...
	var/list/recipes = list(
		...
		"Heavy Pistol",
			...
			list(name="Heavy Pistol Magazine (12mm High velocity)", cost=100, path=/obj/item/ammo_magazine/kurtz_50/hv),
		...
		"12mm Speed Loader",
			list(name="Speed Loader (12mm Special)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50),
			list(name="Speed Loader (12mm High-velocity)", cost=60, path=/obj/item/ammo_magazine/speed_loader_kurtz_50/highvelocity),
		...
		"8.6 Heavy Rifle",
			list(name="Heavy Rifle Magazine (8.6 Standard)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408),
			list(name="Heavy Rifle Magazine (8.6 SLAP)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408/hv),
			list(name="Heavy Rifle Magazine (8.6 Hollow point)", cost=400, path=/obj/item/ammo_magazine/heavy_rifle_408/lethal),
		...
		"12mm Ammo Boxes",
			...
			list(name="Box (12mm High velocity)", cost=330, path=/obj/item/ammo_magazine/ammobox/kurtz_50/hv),
		...
		"6.5 Ammo Packets",
			...
			list(name="Packet (6.5 Rubber)", cost=990, path=/obj/item/ammo_magazine/ammobox/light_rifle_257/rubber),
			list(name="Packet (6.5 Practice)", cost=850, path=/obj/item/ammo_magazine/ammobox/light_rifle_257/practice),
		"7.62 Ammo Packets",
		...
		"8.6 Ammo Boxes",
			list(name="Box (8.6 Standard)", cost=3820, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408),
			list(name="Box (8.6 SLAP)", cost=4420, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/hv),
			list(name="Box (8.6 Hollow point)", cost=4420, path=/obj/item/ammo_magazine/ammobox/heavy_rifle_408/lethal),
