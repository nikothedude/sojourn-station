...
/obj/screen/mov_intent/Click()
	...
	SEND_SIGNAL_LEGACY(parentmob, COMSIG_HUMAN_WALKINTENT_CHANGE, parentmob, newintent)
...
/obj/screen/intent/Click(location, control, params)
	...
	SEND_SIGNAL_LEGACY(parentmob, COMSIG_HUMAN_ACTIONINTENT_CHANGE, parentmob)
