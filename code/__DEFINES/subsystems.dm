...
#define INIT_ORDER_AI_MOVEMENT 15 //We need the movement setup
#define INIT_ORDER_AI_CONTROLLERS 14 //So the controller can get the ref ARBITRARY VALUES NIKO HOLY FUCK TEST THIS
#define INIT_ORDER_EVENTS 13
#define INIT_ORDER_TICKER 12
#define INIT_ORDER_SPAWN_DATA 11
#define INIT_ORDER_MAPPING 10
#define INIT_ORDER_LANGUAGE 9
#define INIT_ORDER_INVENTORY 8
#define INIT_ORDER_CHAR_SETUP 7
